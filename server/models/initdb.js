...
INSERT INTO manga (user_id, name, genre, description, image, status, bookmark, rating) VALUES
  (
  ...
  (
    (SELECT id FROM users WHERE username = 'manga_girl'),
    'Naruto', 
    'Action', 
  ...
  (
    (SELECT id FROM users WHERE username = 'weeb_lord'),
    'Attack on Titan', 
    'Dark Fantasy', 
  ...
  (
    ...
    'Oshi no Ko', 
    'Drama', 
    'A doctor and his terminal patient get murdered and reincarnated as the twin children of their favorite pop idol. Sounds like a weird fanfic until it turns into a brutal, pitch-black critique of the entertainment industry. Genuinely terrifying.',
